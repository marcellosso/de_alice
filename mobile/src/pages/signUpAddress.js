        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.mainBg}>
                    <TouchableHighlight style={styles.backButton} onPress={this.handleBackToSignUpPress}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <TextInput
                            style={[styles.input, { alignSelf: 'flex-start', width: '80%' }]}
                            placeholder="CEP"
                            ...
                            autoCorrect={false}
                        />
                        {/* <Icon name="rocket" size={20} color="#eee" /> */}
                    </View>
                    <TextInput
                        style={styles.input}
                        placeholder="ESTADO"
